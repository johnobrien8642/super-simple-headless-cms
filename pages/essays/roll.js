			...
			if (loc === 'addSection') {
				return (
					<Link
						...
						href={{
							pathname: `/essay/section/add_or_update`,
							query: {
								update: false,
								writingId: obj1._id,
	...
	return (
		<React.Fragment>
			<Head>
				...
				<meta
					name="description"
					content="All essays by Mikowski in their entirety, available to read."
				/>
...
export async function getServerSideProps(context) {
	...
	const pieces = await Essay.find({}).populate('sections');
