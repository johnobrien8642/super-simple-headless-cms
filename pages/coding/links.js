...
const CodingLinks = () => {
	...
	return (
		<React.Fragment>
			...
			<div className="coding-links-container container my-5">
				<Head>
					<title>John E. O'Brien Developer Links</title>
					<meta
						name="description"
						content="My links for Github and Stack Overflow."
					/>
					<link rel="canonical" href={href} />
				</Head>
				<h1>Developer Links</h1>
				<div className="inner mt-5">
					<Link href="https://github.com/johnobrien8642">
						<Image
							width="400"
							height="400"
							src="/GitHub-Mark.png"
					...
					<Link href="https://stackoverflow.com/users/13836220/john-obrien">
						<Image
							width="400"
							height="400"
